...
const AlbumItem = ({ image, name, desc, id }) => {
    return (
        <div className='min-w-[180px] p-4 rounded-xl cursor-pointer glass-panel hover:bg-[rgba(255,255,255,0.1)] hover:-translate-y-2 transition-all duration-300 group shadow-lg hover:shadow-2xl'>
